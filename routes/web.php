...
Route::post('/cash-donation', [SponsorController::class, 'processCashDonation'])->name('cash-donation-process');
Route::get('/non-cash-donation', [SponsorController::class, 'nonCashDonationPage'])->name('non-cash-donation');
Route::post('/donate-non-cash', [SponsorController::class, 'donateNonCash'])->name('donate-non-cash');
