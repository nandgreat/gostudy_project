    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-5" style="margin-top: 40px;">
          <form method="post" action="{{route('user.process.forgotpassword')}}">
            @csrf
            <!-- Login Form -->
            <div class="row">

              <div style="margin-bottom: 200px">
                <p style="font-size: 50px; font-weight: bold; color: #102983">Forgot Password</p>
                <div class="row">
                  <div class="col-sm-5">
              ...
              <button type="submit" style="background-color: #102983; padding-top:15px; padding-bottom:15px;" class="btn btn-block btn-primary mt-sm-3 fadeIn fouth">Submit</button>
            </div>
            <br>
