 ...
 <body>
    ...
    @include('users.fixed.userTopbar')
             ...
             <form class="form-horizontal" action="{{route('user.payment.post',$id)}}" method="post">
                 ...
                 <fieldset>
                     <div id="legend" style="display: flex; justify-content: space-between;">
                         ...
                         <span style="padding-right: 10px;"><span style="font-weight: bold;">London no:</span> +04...</span>
                     ...
                     <div class="control-group">
                         ...
                         <div class="controls">
                             <input  type="text" id="transaction_id" name="transaction_id"
                                 placeholder="" class="input-xlarge" value="{{time()}}">
                         </div>
                     </div>
