                ...
                <div class="icons text-left">
                    ...
                    <div class="row" style="width: 100%;">
                        ...
                        <div class="col-md-7" style="padding-top: 80px; margin-left:20px; padding-right: 40px; padding-left: 40px; padding-bottom: 80px; justify-content: center;  background-color:#A4B1D4; border-radius: 8px; margin-bottom: 100px; margin-top: 30px">
                            ...
                            <div id="bookDeliveryDiv" style="width: 100%; display:flex; flex-direction: column; justify-content: center; align-items: center;">
                                <div style="width: 400px; margin-bottom: 20px; height: 50px; border: 3px solid #005DA3; justify-content: center; display: flex; align-items: center; border-radius: 10px">
                                    <h5 style="color: white">Call Customer Care</h5>
                                </div>
                                <div style="width: 400px; margin-bottom: 20px; height: 50px; border: 3px solid #005DA3; justify-content: center; display: flex; align-items: center; border-radius: 10px">
